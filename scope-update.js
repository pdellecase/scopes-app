...
export async function main(event, context) {
  ...
  const params = {
    ...
    "crmMainOppSyncedAt = :crmMainOppSyncedAt, crmMainOppId = :crmMainOppId, crmMainOppName = :crmMainOppName, crmMainOppStage = :crmMainOppStage, crmMainOppCloseDate = :crmMainOppCloseDate, crmMainOppProbability = :crmMainOppProbability, crmMainOppForecastCat = :crmMainOppForecastCat, crmMainOppServicesReq = :crmMainOppServicesReq, crmMainOppLastModifDate = :crmMainOppLastModifDate, crmMainOppAccountName = :crmMainOppAccountName, crmMainOppRegion = :crmMainOppRegion, crmMainOppOwnerName = :crmMainOppOwnerName, crmMainOppMRR = :crmMainOppMRR, crmMainOppCurrency = :crmMainOppCurrency, crmMainOppDiscount = :crmMainOppDiscount, crmMainOppMEDDPICC = :crmMainOppMEDDPICC, crmMainOppDScore = :crmMainOppDScore, crmServicesOppSyncedAt = :crmServicesOppSyncedAt, crmServicesOppId = :crmServicesOppId, crmServicesOppName = :crmServicesOppName, crmServicesOppStage = :crmServicesOppStage, crmServicesOppCloseDate = :crmServicesOppCloseDate, crmServicesOppProbability = :crmServicesOppProbability, crmServicesOppLastModifDate = :crmServicesOppLastModifDate, crmScopingContact = :crmScopingContact, crmServicesEstimates = :crmServicesEstimates, crmServicesPlanSubTotal = :crmServicesPlanSubTotal, crmServicesPlanTotal = :crmServicesPlanTotal, crmServicesProbability = :crmServicesProbability, crmServicesDue = :crmServicesDue, " +
    ...
    ExpressionAttributeValues: {
      ...
      ":crmScopingContact": data.crmScopingContact || null,
