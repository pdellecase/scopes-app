...
export async function main(event, context) {
  ...
  const params = {
    ...
    ExpressionAttributeValues: {
      ...
      ":crmServicesPartnerDue": data.crmServicesPartnerDue || null,
      ":crmServicesDue": data.crmServicesDue || null,
      ":crmServicesSOWType": data.crmServicesSOWType || null,
      ":crmServicesContractType": data.crmServicesContractType || null,
